...
import { OVEN_TYPES } from './js/nav.js';

// ══════════════════════════════════════════════════════
// 1. OVEN PREHEAT TIMES (minutes)
// ══════════════════════════════════════════════════════

export const OVEN_PREHEAT_MINUTES = {
...
export const FERMENT_METHODS = {
  'cold-72': {
    id: 'cold-72',
    label: '72-Hour Cold Ferment',
    description:
      'Maximum flavor development. Three days of cold fermentation produces deep, complex flavor with excellent texture and an open, airy crumb.',
    reason:
      'You have plenty of time \u2014 let\u2019s use it. A 72-hour cold ferment gives the best possible flavor and texture.',
    minHoursNeeded: 76,
    isColdFerment: true,
  ...
  'cold-48': {
    ...
    description:
      'Great balance of flavor and convenience. Two days in the fridge develops rich, complex taste with good texture.',
    reason:
      'With about two days available, a 48-hour cold ferment gives excellent results \u2014 noticeably better flavor than same-day.',
    minHoursNeeded: 52,
    isColdFerment: true,
    bulkFermentMinutes: 90,
    coldFermentHours: 48,
  ...
  'cold-24': {
    ...
    description:
      'The practical choice. One day in the fridge still adds noticeable flavor complexity over same-day dough.',
    reason:
      'You\u2019ve got about a day \u2014 a 24-hour cold ferment adds real flavor without the multi-day commitment.',
    minHoursNeeded: 28,
    isColdFerment: true,
    bulkFermentMinutes: 90,
    coldFermentHours: 24,
  ...
  'cure-24': {
    ...
    description:
      'Chicago Tavern style. Rolled dough skins are stacked between parchment and refrigerated uncovered for 24 hours. The exposed surface dries out, producing the cracker-snap crust that defines the style.',
    reason:
      'Chicago Tavern dough must be cured uncovered \u2014 it\u2019s what gives the crust its signature snap.',
    minHoursNeeded: 52,
    isColdFerment: false,
  ...
  'same-day': {
    ...
    description:
      'When time is short. A full room-temperature rise gives decent texture but less complex flavor than cold ferment.',
    reason:
      'With less than a day available, a same-day room-temperature rise is your best bet. It\u2019ll still be homemade and delicious.',
    minHoursNeeded: 0,
    isColdFerment: false,
...
export const NO_RISE_STYLES = ['st-louis', 'school-night'];
export const CURING_STYLES = ['chicago-tavern'];

// ══════════════════════════════════════════════════════
// 3. SCHEDULE STEP TEMPLATES
// ══════════════════════════════════════════════════════

export const SCHEDULE_STEP_TEMPLATES = {
  // ── Mixing & Development ───────────────────────────
  mix: {
    id: 'mix',
    label: 'Mix',
    instruction:
      'Combine all dough ingredients. Mix until fully incorporated, then knead until smooth and elastic.',
  ...
  fold: {
    ...
    instruction:
      'Fold the dough like a letter: top edge down to center, then bottom up to overlap. This builds strength and redistributes yeast food.',
  ...
  'stretch-fold': {
    ...
    label: 'Stretch & Fold',
    instruction:
      'Wet your hands. Pull one side of the dough up and fold it over the center. Rotate 90\u00B0 and repeat \u2014 4 folds total. Cover and let rest.',
  ...
  'bulk-ferment': {
    ...
    instruction:
      'Cover the dough and let it rest at room temperature until it has roughly doubled in size.',
  ...
  'second-proof': {
    ...
    instruction:
      'Place shaped dough balls in proofing boxes or on a lightly floured tray, spaced apart. Cover and let proof at room temperature.',
  ...
  'into-fridge': {
    ...
    instruction:
      'Place each dough ball in a lightly oiled container or on a lightly oiled sheet pan. Cover tightly with plastic wrap and refrigerate.',
  ...
  'pull-from-fridge': {
    ...
    instruction:
      'Remove dough from the fridge and let it come to room temperature. The dough should feel soft and pliable, not cold and stiff, before you work with it.',
  ...
  'sheet-roll': {
    ...
    instruction:
      'Run each dough ball through a sheeter or roll firmly with a rolling pin, incorporating flour into the surface. Target paper-thin, no more than 1/8\u2033 thick. Trim edges to a clean circle with a pizza cutter.',
  ...
  dock: {
    ...
    instruction:
      'Perforate the entire dough surface with a docker or fork. Cover every inch \u2014 no bubbles allowed.',
  ...
  'cure-uncovered': {
    ...
    instruction:
      'Stack the rolled, docked dough discs between sheets of parchment paper. Refrigerate UNCOVERED for approximately 24 hours. Do not wrap in plastic \u2014 the exposed surface must dry out. Do not exceed 24 hours or the dough becomes brittle.',
  ...
  'oil-pan': {
    ...
    label: 'Oil the Pan',
    instruction:
      'Generously coat your pan with olive oil \u2014 at least 3\u20134 tablespoons. The oil should pool visibly. This is what fries the bottom of the crust during baking.',
  ...
  'press-first': {
    ...
    instruction:
      'Place the dough ball in the oiled pan. Using flat palms, press with 8\u201310 firm presses only. Do NOT try to fill the pan on the first attempt \u2014 the dough will spring back.',
  ...
  'rest-in-pan': {
    ...
    label: 'Rest in Pan',
    instruction:
      'Cover the pan and let the dough relax for 15\u201320 minutes. The gluten needs to de-tension before the second press.',
  ...
  'press-to-edges': {
    ...
    instruction:
      'Press the relaxed dough to fill the pan completely, pushing firmly into all four corners and slightly up the sides. The dough should be even across the entire surface.',
  ...
  'dimple-rest': {
    ...
    instruction:
      'Press and dimple the dough with oiled fingertips, working from center outward. When it springs back, stop, cover, and wait 10 minutes. Repeat until the dough fills the pan.',
  ...
  'cold-cheese': {
    ...
    instruction:
      'Pull the pizza from the oven. Immediately pile on generous cold, freshly grated provolone (never pre-shredded, never mozzarella). Add cold pepperoni and any other toppings now \u2014 uncooked. Cover or close the box for 3\u20135 minutes so residual heat partially melts the cheese.',
  ...
  'stovetop-start': {
    ...
    instruction:
      'Heat your empty cast iron skillet on the stovetop over medium heat for 5 minutes. Add 2 tablespoons of butter (it should sizzle immediately). Press dough into the hot skillet, working quickly. Cook on the stovetop for 2\u20134 minutes until you see bubbles forming on the surface.',
  ...
  'stretch-and-top': {
    ...
    label: 'Stretch & Top',
    instruction:
      'Open the dough balls and stretch to your target size. Work from the center outward, leaving a rim for the cornicione. Add sauce, cheese, and toppings. Launch into the oven.',
  ...
  'roll-dock-top': {
    ...
    label: 'Roll, Dock & Top',
    instruction:
      'Roll the dough with a rolling pin to your target size \u2014 aim for even, thin coverage edge to edge. Dock the entire surface with a fork. Add sauce, cheese, and toppings. Bake immediately.',
  ...
  'assemble-tavern': {
    ...
    label: 'Assemble & Bake',
    instruction:
      'Invert the cured dough skin so the dried side faces down. Spread sauce edge-to-edge (no raised rim). Place raw Italian sausage chunks on the sauce. Blanket mozzarella over everything \u2014 the cheese locks toppings in place. Bake until well done with dark, crispy edges.',
  ...
  'rest-no-rise': {
    ...
    instruction:
      'Cover the dough loosely and let it rest at room temperature for 10\u201315 minutes. Do not try to shape it right away \u2014 the gluten needs to relax.',
  ...
  eat: {
    ...
    label: 'Eat!',
    instruction:
      'Slice, serve, and enjoy your pizza! Let it rest 2\u20133 minutes out of the oven for the cheese to set \u2014 patience pays off.',
 ...
 */
export function getAvailableFermentMethods(availableHours, styleKey) {
  ...
  const available = [];
  if (availableHours >= FERMENT_METHODS['cold-72'].minHoursNeeded)
    available.push(FERMENT_METHODS['cold-72']);
  if (availableHours >= FERMENT_METHODS['cold-48'].minHoursNeeded)
    available.push(FERMENT_METHODS['cold-48']);
  if (availableHours >= FERMENT_METHODS['cold-24'].minHoursNeeded)
    available.push(FERMENT_METHODS['cold-24']);
 ...
 * Each pizza style has its own authentic step sequence.
 */
export function buildScheduleBackward(
  eatTime,
  ovenType,
  method,
  numPizzas,
  ...
  if (styleKey === 'neapolitan') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~15 min',
        instruction:
          'Dissolve salt in water, add 10% of the flour as a buffer, then add yeast, then remaining flour. Mix by hand or low-speed mixer until smooth and elastic. No autolyse \u2014 Tipo 00 flour hydrates rapidly with the direct method.',
      });
      steps.push({
        ...
        duration: '~2 hours',
        instruction:
          'Cover with a damp cloth (not plastic wrap). Let rest at room temperature (~25\u00B0C / 77\u00B0F) for about 2 hours.',
      });
      steps.push({
      ...
      steps.push({
        ...
        instruction:
          'Place balls in lightly oiled proofing boxes, spaced apart. Cover tightly and refrigerate.',
      });
      steps.push({
      ...
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['second-proof'],
        dateTime: new Date(proofT),
        duration: '~5 hours',
        instruction:
          'Place balls in proofing boxes, spaced apart, covered. Proof at room temperature for 4\u20136 hours until soft and pillowy.',
      });
    }
    ...
    steps.push({
      ...
      instruction:
        'Shape by hand only \u2014 never use a rolling pin. Press from the center outward, pushing air to the edges to form the cornicione. The center should be no more than 3mm thick. Top sparingly and launch into the oven.',
    });
  ...
  if (styleKey === 'new-york') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~10 min',
        instruction:
          'Combine flour, salt, sugar, and yeast. Add cold water and mix until shaggy. Knead 2\u20133 minutes, then drizzle in the oil and continue kneading until the dough passes the windowpane test (~6 min total). Oil goes in AFTER initial gluten development.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['bulk-ferment'],
        dateTime: new Date(bulkStartT),
        duration: '~1 hour',
        instruction:
          'Place in a lightly oiled bowl, cover, and rest at room temperature for about 1 hour.',
      });
      steps.push({ ...SCHEDULE_STEP_TEMPLATES.fold, dateTime: new Date(foldT), subStep: true });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES.ball,
        dateTime: new Date(ballT),
        instruction: ballInstr,
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['into-fridge'],
        dateTime: new Date(fridgeT),
        duration: `${method.coldFermentHours} hours`,
        instruction:
          'Place balls in individual oiled deli containers or on an oiled sheet pan. Cover tightly and refrigerate.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['pull-from-fridge'],
        dateTime: new Date(warmUpT),
        duration: '~2.5 hours',
        instruction:
          'Remove dough balls from the fridge. Let them come to room temperature (target ~65\u00B0F / 18\u00B0C). The dough should stretch without snapping back \u2014 if it resists, give it more time.',
      });
    } else {
      ...
      steps.push({
        ...
        duration: '~6 hours',
        instruction:
          'Place in a lightly oiled bowl, cover, and rest at room temperature until roughly doubled.',
      });
      steps.push({ ...SCHEDULE_STEP_TEMPLATES.fold, dateTime: new Date(foldT), subStep: true });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES.ball,
    ...
    steps.push({
      ...
      dateTime: new Date(stretchTopT),
      instruction:
        'Hand-stretch each ball to your target size (knuckle method). Aim for a uniformly thin center with a modest edge. Sauce in a spiral from center out, grated low-moisture mozzarella, toppings. Launch onto your preheated steel or stone.',
    });
    addPreheatAndEat(preheatT);
    return finalize();
  }
  ...
  if (styleKey === 'chicago-tavern') {
    ...
    steps.push({
      ...
      duration: '~10 min',
      instruction:
        'Combine AP flour, water (50\u201355% hydration), salt, oil, sugar, and yeast. Mix until smooth \u2014 this is a stiff, low-hydration dough. It should feel firm and not sticky.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['bulk-ferment'],
      dateTime: new Date(bulkStartT),
      duration: '~1 hour',
      instruction:
        'Cover and rest at room temperature for about 1 hour. It won\u2019t double \u2014 just needs to relax before balling.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES.ball,
      dateTime: new Date(ballT),
    ...
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['into-fridge'],
      dateTime: new Date(fermentStartT),
      duration: '24 hours',
      instruction:
        'Place balls in lightly oiled containers. Cover tightly and refrigerate for 24 hours to develop flavor.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['pull-from-fridge'],
      dateTime: new Date(pullFermentT),
      duration: '~30 min',
      instruction:
        'Pull dough balls from the fridge. Let them warm slightly for 30 minutes before sheeting.',
    });
    ...
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['pull-from-fridge'],
      id: 'pull-cure',
      dateTime: new Date(pullCureT),
      duration: '~30 min',
      instruction:
        'Pull the cured skins from the fridge. They should feel dry on the surface and slightly stiff \u2014 that\u2019s correct.',
    });
    addPreheatAndEat(preheatT);
  ...
  if (styleKey === 'detroit') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~15 min',
        instruction:
          'Combine bread flour, water (70%+ hydration), salt, sugar, oil, and yeast. Mix until combined \u2014 no heavy kneading needed. The dough will be wet and sticky.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['into-fridge'],
        dateTime: new Date(fridgeT),
        duration: `${method.coldFermentHours} hours`,
        instruction:
          'Oil the dough ball, place in a covered container, and refrigerate. Cold ferment as a ball \u2014 do NOT press into the pan before refrigerating.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['pull-from-fridge'],
        dateTime: new Date(pullT),
        duration: '~30 min',
        instruction:
          'Remove dough ball from fridge. Let it warm slightly (~30 min) before pressing into the pan.',
      });
    } else {
    ...
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['oil-pan'],
      dateTime: new Date(oilPanT),
      instruction:
        'Generously oil your Detroit-style blue steel pan (or heavy rectangular pan) with 2\u20133 tablespoons of olive oil. Coat the bottom and sides completely.',
    });
    ...
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['proof-in-pan'],
      dateTime: new Date(proofStartT),
      duration: '~2 hours',
      instruction:
        'Cover the pan and let the dough proof at room temperature for 1.5\u20132.5 hours. The dough should rise to about one-third of the way up the pan sides.',
    });
    addPreheatAndEat(preheatT);
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['top-detroit'],
      dateTime: new Date(topBakeT),
  ...
  if (styleKey === 'sicilian') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~15 min',
        instruction:
          'Combine bread flour (optionally 80/20 with semolina), water (65\u201370%), salt, sugar, oil, and yeast. Mix until combined.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['into-fridge'],
        dateTime: new Date(fridgeT),
    ...
    steps.push({
      ...
      dateTime: new Date(oilPanT),
      instruction:
        'Coat a heavy sheet pan with at least 3\u20134 tablespoons of olive oil. The oil should pool visibly \u2014 this is what fries the bottom crust.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['dimple-rest'],
      dateTime: new Date(dimpleT),
      instruction:
        'Place dough in oiled pan. Dimple with oiled fingertips for 1\u20132 minutes, rest 10 minutes. Repeat 3\u20134 rounds until dough fills the entire pan.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['proof-in-pan'],
      dateTime: new Date(proofStartT),
      duration: '~3.5 hours',
      instruction:
        'Cover and let the dough proof in the pan at room temperature for 3\u20134 hours. The dough should visibly rise and become bubbly \u2014 this creates the thick, airy, focaccia-like crumb.',
    });
    addPreheatAndEat(preheatT);
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES.parbake,
      dateTime: new Date(parbakeT),
      duration: '~12 min',
      instruction:
        'Bake the naked dough (no toppings) at 475\u2013500\u00B0F for 10\u201312 minutes until barely golden. This stabilizes the thick crust so it won\u2019t be gummy under toppings.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['top-upside-down'],
      dateTime: new Date(topT),
      duration: '~15\u201320 min',
      instruction:
        'Lay sliced mozzarella directly on the parbaked crust. Ladle sauce on top of the cheese. Dust with grated Pecorino Romano and drizzle with olive oil. Return to oven at 450\u2013475\u00B0F for 10\u201320 minutes until sauce bubbles and edges are golden-brown.',
    });
    return finalize();
  }
  ...
  if (styleKey === 'grandma') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~15 min',
        instruction:
          'Combine AP flour, water (64\u201365%), salt, sugar, oil, and yeast. Standard mix.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['into-fridge'],
        dateTime: new Date(fridgeT),
    ...
    steps.push({
      ...
      dateTime: new Date(oilPanT),
      instruction:
        'Coat a dark metal sheet pan with 4+ tablespoons of olive oil, including the sides. Dark pans absorb more heat for a better fried bottom.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['dimple-rest'],
      id: 'press-grandma',
      dateTime: new Date(pressT),
      duration: '~15\u201320 min',
      label: 'Press into Pan',
      instruction:
        'Press cold dough directly into the oiled pan, stretching to all edges. Brief rest only (15\u201320 min) \u2014 do NOT let it rise like a Sicilian. The crust should stay thin and dense.',
    });
    addPreheatAndEat(preheatT);
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['top-upside-down'],
      ...
      duration: '~16\u201320 min',
      instruction:
        'Lay sliced mozzarella or provolone rounds directly on the raw dough. Dollop chunky, raw, garlic-forward sauce over the cheese \u2014 leave gaps, don\u2019t spread edge-to-edge. Dust with Pecorino Romano. Bake at 450\u00B0F for 16\u201320 minutes (rotate halfway). Finish with an olive oil drizzle.',
    });
    return finalize();
  }
  ...
  if (styleKey === 'new-haven') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~10 min',
        instruction:
          'Combine high-gluten bread flour, water (68\u201370%), salt, and yeast. NO oil, NO sugar. Keep mixing minimal \u2014 just until combined. The dough will be wet and sticky.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['into-fridge'],
        dateTime: new Date(fridgeT),
        duration: `${method.coldFermentHours} hours`,
        instruction:
          'Place dough in a lightly oiled container, cover tightly, and refrigerate. The long cold ferment is fundamental to New Haven apizza \u2014 it develops the distinct tang and complex flavor.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['pull-from-fridge'],
        dateTime: new Date(warmUpT),
      ...
      steps.push({
        ...
        duration: '~10 min',
        instruction:
          'Combine high-gluten bread flour, water (68\u201370%), salt, and yeast. NO oil, NO sugar. Keep mixing minimal.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['bulk-ferment'],
        dateTime: new Date(bulkStartT),
  ...
  if (styleKey === 'ohio-valley') {
    ...
    steps.push({
      ...
      duration: '~10 min',
      instruction:
        'Combine bread flour, water (58%), salt, sugar, oil, and yeast. Standard bread-style dough.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['bulk-ferment'],
      dateTime: new Date(bulkStartT),
    ...
    steps.push({
      ...
      instruction:
        'Oil a sheet pan generously. Press and stretch dough to fill the pan. Dock the entire surface with a fork.',
    });
    addPreheatAndEat(preheatT);
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES.parbake,
      dateTime: new Date(firstBakeT),
      duration: '~8 min',
      instruction:
        'Bake the plain dough (no toppings) at 500\u00B0F for 7\u20139 minutes. This parbake is essential.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['second-bake'],
      dateTime: new Date(sauceT),
      duration: '~10 min',
      instruction:
        'Pull from oven. Add a light layer of sauce only (leave edges bare). Return to oven and bake at 425\u00B0F for 7\u201310 minutes until golden brown.',
    });
  ...
  if (styleKey === 'cast-iron') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~10 min',
        instruction:
          'Combine AP flour, water (62%), salt, sugar, oil, and yeast. Mix until smooth.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['into-fridge'],
        dateTime: new Date(fridgeT),
    ...
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['stretch-and-top'],
      id: 'oven-finish',
      dateTime: new Date(ovenFinishT),
      label: 'Top & Oven Finish',
      instruction:
        'Add sauce, cheese, and toppings while still on the burner. Transfer skillet to the preheated oven and bake 10\u201315 minutes until cheese is bubbly. Rest 2 minutes in skillet, then slide onto a cutting board (don\u2019t cut in the pan).',
    });
    return finalize();
  }
  ...
  if (styleKey === 'pan') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~5 min',
        instruction:
          'Combine bread flour, water (70%), salt, sugar, oil, and yeast. Mix by hand until no dry flour remains. No kneading needed.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['into-fridge'],
        dateTime: new Date(fridgeT),
    ...
    steps.push({
      ...
      dateTime: new Date(oilPanT),
      instruction:
        'Pour 1\u20132 tablespoons of olive oil into each cast iron skillet or cake pan.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['dimple-rest'],
      dateTime: new Date(dimpleT),
      instruction:
        'Turn dough into oiled pan to coat. Press outward from center with oiled fingertips. When it springs back, stop, wait 10 minutes, try again. Repeat until dough fills the pan.',
    });
    addPreheatAndEat(preheatT);
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['stretch-and-top'],
      dateTime: new Date(topBakeT),
      instruction:
        'Spread sauce with the back of a spoon. Add aged low-moisture mozzarella (block, grated) all the way to the edges. Bake at 550\u00B0F for 12\u201315 minutes. If the bottom needs more color, place the pan on a burner over medium heat for 1\u20132 minutes.',
    });
    return finalize();
  }
  ...
  if (styleKey === 'st-louis') {
    ...
    steps.push({
      ...
      duration: '~5 min',
      instruction:
        'Combine AP flour, baking powder (1 tsp per 250g flour \u2014 NO yeast), salt, oil, water, and a touch of corn syrup. Stir together until combined. No kneading needed.',
    });
    steps.push({
      ...
      duration: '~10 min',
      instruction:
        'Let the dough rest 10 minutes. This is NOT a rise \u2014 there\u2019s no yeast. Just letting the gluten relax for easier rolling.',
    });
    addPreheatAndEat(preheatT);
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['roll-dock-top'],
      dateTime: new Date(rollDockTopT),
      duration: '~12 min',
      instruction:
        'Roll the dough cracker-thin (thinner than Chicago tavern) \u2014 target 1/8\u2033 or less, edge to edge with no rim. Dock the entire surface with a fork. Spread sweet tomato sauce, distribute toppings, then blanket Provel cheese on top. Bake at 425\u2013475\u00B0F for 9\u201311 minutes. Square cut only.',
    });
    return finalize();
  }
  ...
  if (styleKey === 'school-night') {
    ...
    steps.push({
      ...
      duration: '~5 min',
      instruction:
        'Combine AP flour, water (60%), salt, oil, sugar, and yeast. Mix until smooth, 3\u20135 minutes. For extra tang, add a splash of vinegar or a tablespoon of yogurt.',
    });
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['rest-no-rise'],
      dateTime: new Date(restT),
      duration: '~10\u201315 min',
      instruction:
        'Cover and rest 10\u201315 minutes. Not a rise \u2014 just gluten relaxation. The dough will be cooperative and easy to shape.',
    });
    addPreheatAndEat(preheatT);
    steps.push({
      ...SCHEDULE_STEP_TEMPLATES['stretch-and-top'],
      dateTime: new Date(shapeTopT),
      instruction:
        'Roll or press to desired size. Top with sauce, cheese, and toppings. Bake immediately at 475\u2013525\u00B0F for 8\u201312 minutes.',
    });
    return finalize();
  }
  ...
  if (styleKey === 'thin-crust') {
    ...
    if (method.isColdFerment) {
      ...
      steps.push({
        ...
        duration: '~10 min',
        instruction:
          'Combine AP flour, water (55%), salt, oil, and yeast. This is a stiff, low-hydration dough designed for rolling.',
      });
      steps.push({
        ...SCHEDULE_STEP_TEMPLATES['bulk-ferment'],
        dateTime: new Date(bulkStartT),
    ...
    steps.push({
      ...
      dateTime: new Date(rollDockTopT),
      instruction:
        'Roll each ball with a rolling pin to ~1/8\u2033 thick, even edge to edge. Dock the entire surface with a fork. Top lightly \u2014 thin crust can\u2019t support heavy loads. Bake at 475\u2013525\u00B0F for 6\u201310 minutes.',
    });
    return finalize();
  }
