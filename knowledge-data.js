...
export const STYLE_LIBRARY = {
  ...
  'ohio-valley': {
    ...
    authenticity:
      'Authentic Ohio Valley pizza has cold shredded provolone applied after baking — this is non-negotiable. The crust is a medium-thickness, slightly bready rectangle. Pepperoni is also added cold on top of the cheese, not baked on. The pizza is typically sold by the slice from a counter window and eaten immediately while the contrast between hot crust and cold toppings is at its peak.',
    debates:
    ...
    combos: [
      {
        ...
        name: 'Margherita DOC',
        ingredients: [
          'Sauce: San Marzano crushed tomato',
          'Cheese: Mozzarella di bufala',
          'Garnish: Fresh basil, EVOO drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Fresh cherry tomatoes',
          'Cheese: Buffalo mozzarella DOP',
          'Topping: Garlic',
          'Garnish: Chiffonade basil, EVOO drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Garlic oil base',
          'Cheese: Burrata (after bake)',
          'Toppings: Ramps, roasted asparagus',
          'Garnish: Lemon zest',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          'Sauce: Cooked tomato sauce',
          'Cheese: Low-moisture mozzarella',
          'Garnish: Dried oregano, grated Parm',
        ],
      ...
      },
      {
        ...
        ingredients: [
          ...
          'Cheese: Mozzarella, burrata (after bake)',
          'Topping: Prosciutto di Parma',
          'Garnish: Chiffonade basil, EVOO drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Garlic oil base',
          'Cheese: Low-moisture mozz, ricotta dollops',
          'Toppings: Marinated artichoke hearts, roasted garlic',
          'Garnish: Chiffonade basil',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          ...
          'Cheese: Low-moisture mozz',
          'Toppings: Italian sausage (raw crumbles), hot giardiniera',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Brown butter tomato sauce',
          'Cheese: Mozzarella',
          'Toppings: Slagel Farm sausage, hot giardiniera',
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Crushed tomato',
          'Cheese: Low-moisture mozz',
          'Toppings: Italian sausage, spring onions, roasted ramps',
          'Garnish: EVOO drizzle',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          'Sauce: Tomato racing stripes on top',
          'Cheese: Wisconsin brick cheese (to edges)',
          'Topping: Pepperoni (under cheese)',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Tomato stripe sauce',
          'Cheese: Fresh mozzarella with frico edge',
          'Toppings: Cup-and-char pepperoni, pickled jalape\u00F1os',
          'Garnish: Hot honey drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Garlic oil base',
          'Cheese: Brick cheese, ricotta dollops',
          'Toppings: Fresh English peas, spring onion',
          'Garnish: Lemon zest, EVOO drizzle',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          'Sauce: Crushed tomato (over cheese)',
          'Cheese: Low-moisture mozz (under sauce)',
          'Garnish: Pecorino Romano, EVOO drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Fra diavolo tomato',
          'Cheese: Fresh mozzarella',
          'Topping: Thick-cut spicy pepperoni',
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Crushed tomato (over cheese)',
          'Cheese: Low-moisture mozz (under)',
          'Toppings: Marinated artichoke hearts, Castelvetrano olives',
          'Garnish: Chiffonade basil',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          'Sauce: Crushed tomato with garlic (over cheese)',
          'Cheese: Sharp provolone rounds (under sauce)',
          'Garnish: Pecorino Romano, EVOO drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Tomato sauce (over cheese)',
          'Cheese: Fresh mozzarella, Pecorino Romano',
          'Topping: Sesame seed bottom crust',
          'Garnish: Chiffonade basil, EVOO drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Basil-ramp pesto (over cheese)',
          'Cheese: Fresh mozz slices (under)',
          'Toppings: Sugar snap peas, cherry tomato halves',
          'Garnish: EVOO drizzle',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          'Sauce: Thin tomato sauce',
          'Cheese: Fresh mozz slices',
          'Garnish: Chiffonade basil, EVOO drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Vodka sauce, marinara, and pesto (swirled)',
          'Cheese: Fresh mozzarella',
          'Garnish: Chiffonade basil, Pecorino Romano',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Lemon-garlic oil base',
          'Cheese: Fontina',
          'Toppings: Shaved asparagus, prosciutto (after bake)',
          'Garnish: Lemon zest, EVOO drizzle',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          'Sauce: Buttery tomato sauce (on top)',
          'Cheese: Mozzarella (on dough + pressed against pan walls)',
          'Garnish: Dried oregano, red pepper flakes',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Buttery tomato sauce (on top)',
          'Cheese: Mozzarella (pressed against pan walls)',
          'Toppings: Italian sausage, giardiniera, saut\u00E9ed onions',
          'Garnish: Dried oregano',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Garlic oil base',
          'Cheese: Mozzarella',
          'Toppings: Roasted asparagus, artichoke hearts, spring onion',
          'Garnish: Chiffonade basil',
        ],
    ...
    combos: [
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Sweet tomato sauce',
          'Cheese: Provel',
          'Toppings: House sausage, pepperoni, mushrooms',
          'Garnish: Fresh oregano',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Garlic oil base',
          'Cheese: Provel',
          'Toppings: Roasted asparagus, thick-cut bacon',
          'Garnish: EVOO drizzle',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          'Sauce: Crushed tomato',
          'Cheese: Pecorino Romano (no mozzarella)',
          'Topping: Garlic',
          'Garnish: EVOO drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Garlic oil base',
          'Cheese: Pecorino Romano (no mozzarella)',
          'Toppings: Fresh littleneck clams, garlic',
          'Garnish: EVOO drizzle, dried oregano',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Tomato sauce',
          'Cheese: Mozzarella',
          'Toppings: Sausage, bacon, pepperoni',
      ...
      },
      {
        ...
        ingredients: [
          ...
          'Toppings: Fresh littleneck clams, ramps, garlic',
          'Garnish: EVOO drizzle, lemon zest',
        ],
    ...
    combos: [
      {
        ...
        name: 'Beto\u2019s Best',
        ingredients: [
          'Sauce: Crushed tomato sauce (baked on)',
          'Cheese: Cold shredded provolone (after bake)',
          'Topping: Pepperoni (after bake)',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Tomato sauce (baked on)',
          'Cheese: Cold provolone (after bake)',
          'Toppings: Pepperoni (baked), shredded lettuce (cold)',
          'Garnish: Italian dressing drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Tomato sauce (baked on)',
          'Cheese: Cold provolone (after bake)',
          'Toppings: Diced radish, shaved snap peas (cold)',
          'Garnish: Chiffonade basil',
        ],
    ...
    combos: [
      {
        ...
        ingredients: [
          'Sauce: Crushed tomato',
          'Cheese: Fresh mozzarella',
          'Garnish: Chiffonade basil, butter in pan',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Fresh chunky tomato',
          'Cheese: Fresh whole-milk mozzarella',
          'Toppings: Cup-and-char pepperoni, jalape\u00F1o',
          'Garnish: Fresh oregano, Calabrian chili honey drizzle',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Garlic oil base',
          'Cheese: Fontina',
          'Toppings: Fresh English peas, crispy pancetta, spring onion',
          'Garnish: EVOO drizzle, lemon zest',
        ],
    ...
    combos: [
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Tomato sauce',
          'Cheese: Fresh mozzarella',
          'Toppings: Soppressata picante, fresh chili',
          'Garnish: Hot honey drizzle, chiffonade basil',
        ],
      ...
      },
      {
        ...
        ingredients: [
          'Sauce: Garlic oil base',
          'Cheese: Shredded mozzarella',
          'Toppings: Asparagus tips, cherry tomato halves, spring onion',
          'Garnish: EVOO drizzle',
        ],
    ...
    buyLinks: [
      {
        ...
        url: 'https://www.amazon.com/s?k=caputo+pizzeria+00+flour',
        note: 'Industry standard for Neapolitan',
      },
      {
        brand: 'Caputo Nuvola (Sky Blue)',
        url: 'https://www.amazon.com/s?k=caputo+nuvola+flour',
        note: 'Higher hydration, lighter crumb',
      },
      {
        brand: 'Le 5 Stagioni',
        url: 'https://www.amazon.com/s?k=le+5+stagioni+00+pizza+flour',
        note: 'Great alternative, slightly lower absorption',
      },
      {
        brand: "Antimo Caputo Chef's (Red)",
        url: 'https://www.amazon.com/s?k=caputo+chef+flour+red+bag',
        note: 'Finer grind, lower protein, softer crust',
      },
    ],
  },
    ...
    buyLinks: [
      {
        ...
        url: 'https://www.amazon.com/s?k=king+arthur+sir+lancelot+flour',
        note: '14.2% protein, the gold standard',
      },
      {
        brand: 'General Mills All Trumps',
        url: 'https://www.amazon.com/s?k=all+trumps+high+gluten+flour',
        note: 'Industry standard for NY shops',
      },
      {
        brand: 'Full Court Press',
        url: 'https://www.amazon.com/s?k=full+court+press+flour',
        note: 'Similar to All Trumps, widely available',
      },
    ],
  },
    ...
    buyLinks: [
      {
        ...
        url: 'https://www.amazon.com/s?k=king+arthur+all+purpose+flour',
        note: '11.7% protein \u2014 higher than most AP',
      },
      {
        brand: 'Gold Medal AP',
        url: 'https://www.amazon.com/s?k=gold+medal+all+purpose+flour',
        note: '10.5% protein, the standard baseline',
      },
      {
        brand: 'Heckers / Ceresota',
        url: 'https://www.amazon.com/s?k=heckers+ceresota+flour',
        note: 'Northeast favorite, ~11.5% protein',
      },
    ],
  },
    ...
    buyLinks: [
      {
        ...
        url: 'https://www.amazon.com/s?k=king+arthur+bread+flour',
        note: '12.7% protein, the reliable choice',
      },
      {
        brand: 'Gold Medal Better for Bread',
        url: 'https://www.amazon.com/s?k=gold+medal+better+for+bread+flour',
        note: '12.5% protein, widely available',
      },
      {
        brand: "Bob's Red Mill Artisan Bread",
        url: 'https://www.amazon.com/s?k=bobs+red+mill+artisan+bread+flour',
        note: 'Great for long cold ferments',
      },
      {
        brand: 'Central Milling Organic Bread',
        url: 'https://www.amazon.com/s?k=central+milling+organic+bread+flour',
        note: 'High-quality, consistent results',
      },
    ],
  },
    ...
    buyLinks: [
      {
        ...
        url: 'https://www.amazon.com/s?k=caputo+semola+rimacinata',
        note: 'Fine re-milled, high absorption',
      },
      {
        brand: "Bob's Red Mill Semolina",
        url: 'https://www.amazon.com/s?k=bobs+red+mill+semolina+flour',
        note: 'Coarser grind, great crunch',
      },
    ],
  },
};
...
export const YEAST_GUIDE = {
  'instant-dry': {
    ...
    buyLinks: [
      {
        brand: 'SAF Red Instant Yeast',
        url: 'https://www.amazon.com/s?k=saf+red+instant+yeast',
        note: 'Industry standard, buy the 1 lb brick',
      },
      {
        brand: 'Fleischmann\u2019s RapidRise',
        url: 'https://www.amazon.com/s?k=fleischmanns+rapidrise+yeast',
        note: 'Widely available in grocery stores',
      },
    ],
  ...
  'active-dry': {
    ...
    buyLinks: [
      {
        brand: 'Fleischmann\u2019s Active Dry',
        url: 'https://www.amazon.com/s?k=fleischmanns+active+dry+yeast',
        note: 'The classic red-label jar',
      },
      {
        brand: 'Red Star Active Dry',
        url: 'https://www.amazon.com/s?k=red+star+active+dry+yeast',
        note: 'Reliable alternative, widely available',
      },
    ],
  },
  ...
  fresh: {
    ...
    buyLinks: [
      {
        brand: 'Fleischmann\u2019s Fresh Yeast',
        url: 'https://www.amazon.com/s?k=fleischmanns+fresh+cake+yeast',
        note: 'Check bakery section, often behind the counter',
      },
      {
        brand: 'Red Star Fresh Yeast',
        url: 'https://www.amazon.com/s?k=red+star+fresh+cake+yeast',
        note: 'Ask your local bakery if stores don\u2019t carry it',
      },
    ],
  },
};
...
// ── Cheese & Sauce Guide ────────────────────────────
export const CHEESE_SAUCE_GUIDE = {
  cheeses: [
    {
      id: 'fresh-mozz',
