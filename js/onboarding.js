...
const PieLabOnboarding = (() => {
  ...
  function hasProfile() {
    try {
      const profile = PieLabStorage.getJSON('pielab-user-profile');
  ...
  const steps = [
    ...
    },
    {
      ...
      detail:
        'Supports 13 regional styles from Neapolitan to Detroit, with adjustments for your altitude and oven type.',
    },
    {
      icon: '📅',
    ...
    },
    {
      ...
      detail:
        'Earn skill badges for each style as you bake more — from First Bake all the way to Pizzaiolo.',
    },
    {
      icon: '📚',
      title: 'The Tools Hub',
