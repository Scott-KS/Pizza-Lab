...
const PIZZA_RECIPES = {
  ...
  pan: {
    ...
    toppings: [
      { ingredient: "Shredded Mozzarella (on dough + pressed to pan walls)", base: 200 },
    ],
    idealTemp: { min: 450, max: 500 },
    bakeTime: { hot: "14–18 minutes", medium: "20–25 minutes", low: "28–32 minutes" },
    rackPosition: "Lower third — low rack to crisp the oiled pan bottom and caramelize the cheese crown. Place pan on steel or stone for extra bottom heat. Rack only: lowest rack.",
    tips: [
      { level: "beginner", tip: "The caramelized cheese crown is the whole point. Press shredded mozzarella up the sides and against the pan walls — it will melt, fry, and form a crispy golden halo." },
      { level: "beginner", tip: "Cheese goes on the dough first, then sauce on top. This is non-negotiable for the Pequod's style — it keeps the crust from going soggy and creates the signature layering." },
      { level: "beginner", tip: "Oil the pan generously — 2–3 tablespoons minimum. The oil plus the cheese fat is what fries the bottom and sides into that signature crust." },
      { level: "intermediate", tip: "Cold-ferment 24–48 hours before pressing into the pan. The extra sugar in this dough develops better caramelization and flavor with a long ferment." },
      { level: "intermediate", tip: "Press the dough in stages — initial press, 20-minute rest, second press to edges. Then add cheese to the walls before the dough can spring back." },
      { level: "intermediate", tip: "Place the pan on a preheated baking steel or stone. The extra conductive heat from below is what crisps the bottom like Pequod's." },
      { level: "pro", tip: "Watch the cheese crown carefully in the last few minutes — you want it dark golden, not burnt. The line between caramelized and charred is thin." },
      { level: "pro", tip: "Try a cold-ferment in the pan itself — oil it, press the dough in, add the cheese to the walls, cover, and refrigerate overnight. Let it come to room temp before baking." },
      { level: "pro", tip: "Use a deep-sided cake pan or cast iron for the best cheese crown — the taller the walls, the more surface area for caramelization." },
    ],
  },
