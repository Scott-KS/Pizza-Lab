...
const PIZZA_RECIPES = {
  neapolitan: {
    ...
    tips: [
      ...
      { level: "intermediate", tip: "Cold-ferment your dough balls individually in airtight containers for 24–48 hours for deeper flavor and better structure." },
      ...
      { level: "pro", tip: "San Marzano DOP tomatoes, torn by hand with a pinch of salt, are the only sauce Neapolitan needs. No cooking required." },
