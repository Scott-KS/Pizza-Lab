...
Add a step-by-step guided walkthrough when the user arrives at kitchen.html during onboarding (`?onboarding=1`). Instead of just showing a banner, highlight each form field one at a time with an explanation of _why_ we're asking:
