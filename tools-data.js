...
const OVEN_SETUPS = [
  ...
  },
  {
    ...
    styleBakeTimes: {
      ...
      "new-haven": { time: "90 sec–3 min", note: "Portable ovens can replicate coal-oven intensity. Oblong shape may need trimming to fit." },
      "ohio-valley": { time: "3–5 min", note: "Bake the base in the portable oven, then add cold cheese outside. Works if the pan fits." },
    ...
    tips: [
      ...
      "Gas models are more consistent; wood/charcoal gives better flavor.",
    ],
  },
  {
    id: "wood-fired",
